...
@Disabled
@SpringBootTest(classes = NaverClientIntegrationTestWithJunit.TestConfig.class) // 테스트와 함께 로드할 클래스 지정
@ActiveProfiles("test")
class NaverClientIntegrationTestWithJunit {
  ...
  @Test
  @DisplayName("naverClient를 호출하여 HTTP 키워드로 책을 조회한다.")
  void callNaver() {
